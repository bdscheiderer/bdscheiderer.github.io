...
The exploratory data analysis will start with a comparison of the users and the activities with the dumbbell:
```{r}
...
dim(pmlNoNA)
# perform same cleaming of the pmltesting data set to match pm1NoNA
